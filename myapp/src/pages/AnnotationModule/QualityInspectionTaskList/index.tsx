import {Button, Card, ConfigProvider, Pagination, Table, message} from 'antd';
...
const QualityInspectionTaskList: React.FC = () => {
  //处理表格选中项
...
//   };
  ...
  //跳转到质检任务详情页面
  const goQualityInspectTaskDetail = () => {
    history.push('./qualityInspectTaskList/qualityInspectTaskDetail');
  }
  ...
  const columns: ColumnsType<DataType> = [
      {
        title: '任务名称',
        dataIndex: 'taskName',
        render: (text: string) => (<><a onClick={goQualityInspectTaskDetail}>{text}</a></>),
        align: 'center',
      },
      {
        title: '任务ID',
...
export default QualityInspectionTaskList;
